...
<!-- Datatables 
<script src="./vendors/DataTables/jQuery-3.3.1/jquery-3.3.1.min.js"></script>
<script src="./vendors/DataTables/Buttons-1.6.5/js/dataTables.bootstrap.min.js"></script>
<script src="./vendors/DataTables/Buttons-1.6.5/js/dataTables.buttons.min.js"></script>
<script src="./vendors/DataTables/Buttons-1.6.5/js/buttons.bootstrap4.min.js"></script>
...
<script src="./vendors/DataTables/FixedHeader-3.1.8/js/dataTables.fixedHeader.min.js"></script>

<script src="./vendors/DataTables/KeyTable-2.5.3/js/dataTables.keyTable.min.js"></script>

<script src="./vendors/DataTables/Responsive-2.2.7/js/dataTables.responsive.min.js"></script>
<script src="./vendors/DataTables/Responsive-2.2.7/js/responsive.bootstrap.js"></script>
<script src="./vendors/datatables.net-responsive/js/FileSaver.js"></script>
<script src="./vendors/DataTables/Buttons-1.6.5/js/buttons.colVis.min.js"></script>
<script src="./vendors/DataTables/FixedColumns-3.3.2/js/dataTables.fixedColumns.min.js"></script>-->
