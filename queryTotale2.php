    ...
    foreach ($list as $key => $value) {
        if (isset($_POST[$radice . $value['id']])) {
            ...
            if ($key_table == 'group') {
                ...
                $contatore_group = $contatore_group + $totale;
                $somma_volume_group = $somma_volume_group + $volume;
            }
        }
    }
}
...
$data_output['totali'] = "<table width=\"100%\" border=\"0\">" . $summary . "<tr><td align=\"left\" style=\"font-weight: bold;\">TOTALE:</td><td align=\"center\" style=\"font-weight: bold;\">($contatore_group)</td><td align=\"right\" style=\"font-weight: bold;\" title=\"\">" . number_format(round($somma_volume_group / 1000, 0), 0, ',', '.') . " K</td></tr>\n        </table>";
