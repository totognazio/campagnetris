      ...
      ?>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2><?php echo $titolo; ?><span id="conteggio_righe"><?php #echo $sottotitolo; 
                                                                      ?></span></h2>
            ...
            ?>
              ...
              <?php
                        ...
                        function stampaMultiSelect($nome_variabile, $query, $nome_campo, $id_campo = NULL, $messaggio = "", $selected = NULL, $js_name = NULL, $nome_group = NULL)
                        {
                        ...
                        function stampaMultiSelect2($nome_variabile, $array_select, $nome_campo, $id_campo = NULL, $messaggio = "", $selected = NULL, $js_name = NULL, $nome_group = NULL)
                        {
                    ...
                    <h3><?php echo $subtitle; ?>
                      <?php if ($job_role > 6) { ?>
                        <center>
                          ...
                          <button type="button" class="btn btn-info btn-lg" <?php #echo $disable; 
                                                                            ?> data-toggle="modal" data-target="#importModal"><i class="fa fa-upload"></i> Upload RFI</button>
                        </center>
                      <?php }
